...
#--------------I${subst :, -I,$(CPATH)}--------------------------------------------------------------
FCOMP   = OMPI_FC=$(INSTALL_PREFIX)/bin/flang $(INSTALL_PREFIX)/bin/mpif90
CCOMP   = OMPI_CC=$(INSTALL_PREFIX)/bin/clang $(INSTALL_PREFIX)/bin/mpicc
CPPCOMP = OMPI_CXX=$(INSTALL_PREFIX)/bin/clang++ $(INSTALL_PREFIX)/bin/mpicxx
LINK    = OMPI_FC=$(INSTALL_PREFIX)/bin/flang $(INSTALL_PREFIX)/bin/mpif90 -std=c++14
# pre-processor flag
PP      = -D
#----------------------------------------------------------------------------
# Compilation flags
...
#----------------------------------------------------------------------------
FFLAGS_OPT   = -c -O0 -fdefault-real-8 -Wuninitialized #-fdefault-double-8 -emit-llvm -fallow-argument-mismatch \
